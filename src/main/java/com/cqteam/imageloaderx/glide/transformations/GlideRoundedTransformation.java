package com.cqteam.imageloaderx.glide.transformations;
...
public class GlideRoundedTransformation extends BitmapTransformation {
    ...
    public GlideRoundedTransformation(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public GlideRoundedTransformation(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof GlideRoundedTransformation &&
                ((GlideRoundedTransformation) o).radius == radius &&
                ((GlideRoundedTransformation) o).diameter == diameter &&
                ((GlideRoundedTransformation) o).margin == margin &&
                ((GlideRoundedTransformation) o).cornerType == cornerType;
    }
